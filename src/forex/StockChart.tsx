...
// interface Props { type, data: initialData, width, ratio}

class CandleStickChartWithMA extends React.Component<any> {
  render() {
    const ema20 = ema()
      .options({
    ...
    const { type, data: initialData, width, height, ratio = 1 } = this.props;
    ...
    return (
      <ChartCanvas
        ...
        width={width}
        ratio={ratio}
        margin={{ left: 50, right: 40, top: 10, bottom: 30 }}
        type={type}
        seriesName="MSFT"
        data={data}
        xScale={xScale}
      ...
      >
        <Chart
          ...
          padding={{ top: 10, bottom: 10, right: 54 }}
        >
